...
def mappletfiles_pre(mtgfile, bgeomfile=None):
    ...
    mtg = MTG(mtgfile)
    add_mtg_property(mtg, "interceptedLightAmount")
...
def add_mtg_property(mtg, propertyName):
...
def setVetexProperties(vid, sid, rootedgraph):
    ...
    rootedgraph.vertex_property("type")[sid] = "MtgScaleClass" #class_name + "_" + "unit" #vtypedic[label[0]]
