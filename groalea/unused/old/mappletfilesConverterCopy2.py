...
def uppermetamerLevelConvert(rootedgraph):
...
def convert(mtgfile, bgeomfile):
    ...
    vlist, metamerlist = mappletfiles_pre(mtgfile, bgeomfile)
    rootedgraph = rootedgraph_pre()

    uppermetamerLevelConvert(rootedgraph)
    return rootedgraph
"""
    for vid in vlist:
...
def subMetamerLevelConvert(edge_type_list_2children_metamers, children_sid_list, sid, metamer, parentmetamer, rootedgraph):
    ...
    for i in range(slen):
        ...
        geo_list_index = i
        addStructure4SubMetamerLevel(edge_type_list_2children_metamers, children_sid_list, shape_geo_pro, geo_list_index, trans_geo_list, color, trans_geo_composite_localmatrix, sid, metamer_shape_num, preshape_geo_sum, rootedgraph)
...
def addStructure4SubMetamerLevel(edge_type_list_2children_metamers, children_sid_list, shape_geo_pro, geo_list_index, trans_geo_list, color, trans_geo_composite_localmatrix, sid, metamer_shape_num, preshape_geo_sum, rootedgraph):
